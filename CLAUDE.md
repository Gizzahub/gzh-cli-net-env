...
**Module**: `github.com/gizzahub/gzh-cli-net-env` | **Binary root cmd**: `net-env` |
**Consumer Go**: 1.26+ | **Development/CI toolchain**: 1.26.7
...
`github.com/gizzahub/gzh-cli-net-env` — Consumer Go 1.26+; development and CI
use Go 1.26.7.
